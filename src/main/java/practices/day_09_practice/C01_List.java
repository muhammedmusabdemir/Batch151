    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 0; i < list.size(); i++) { // 0'dan listin uzunluguna kadar donguye aldik
            ...
            if (list.get(i)>10) { // listin i. index'indeki elemani getirdik 10'dan buyuk mu kontrol ettik
                list.set(i, list.get(i)*2); // buyukse i. index'indeki elemani 2 katiyla set ettik
            }
