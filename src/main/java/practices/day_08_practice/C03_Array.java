...
public class C03_Array {
     ...
     */
        ...
        for (int i = 0; i < arr1.length; i++) {  // distaki array'lerin kisa olaninin sayisinca donguye alicam

            if (arr1[i].length<arr2[i].length) {  // arr1'in i. indexindeki dis array'in eleman uzunlugu ile
                                                  // arr2'in i. indexindeki dis array'in eleman uzunlugunu karsilastirdik
                sinir = arr1[i].length;
