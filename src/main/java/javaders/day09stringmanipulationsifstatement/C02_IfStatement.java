...
public class C02_IfStatement {
    ...
    public static void main(String[] args) {
        ...
        //Ex: Sayi -1 ile 10 arasında ise ekrana "Rakam" yazdiriniz
        ...
        /*
        Math class'i onemli bir class'tir. Icerisinde bir cok method barindirir.
        ...
        int number2 = -123;
        if(number2>99 && number<1000 || number2>-1000 && number2<-99){
