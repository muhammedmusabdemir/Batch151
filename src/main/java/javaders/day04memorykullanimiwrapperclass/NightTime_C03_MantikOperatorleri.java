...
public class NightTime_C03_MantikOperatorleri {
    ...
    < Kucuktur
    > Buyuktur
    = Assignment (Atama Operatoru)

    1< 4 < 5  ==> metematik uclu karsilastirma yapar Ancak Java uclu kiyas yapamaz
    ...
    & ile && arasindaki fark
    (3<5 && 3<9 && 11<2 && 4<8 && 2<3) ilk false donen yerde kod durur ve false çıktısı verir Daha hizli calistigi icin && tercih edilir
    ...
    (3<5 & 3<9 & 11<2 & 4<8 & 2<3) hepsine bakip en son bir hata bile olsa false dondurur Daha yavas
