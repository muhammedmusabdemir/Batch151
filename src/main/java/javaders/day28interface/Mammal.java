package javaders.day28interface;
    ...
    /*
       1)Child     Parent
         ...
         *2)Abstract Class'lar multiple inheritence'i desteklemez ama interface'ler destekler.
         *3)Abstract Class'lar icinde her turlu variable olusturulabilir, interface'ler icindeki variablke'lar public, static ve final olmak zorundadir.
