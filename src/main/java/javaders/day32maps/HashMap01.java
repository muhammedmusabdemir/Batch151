...
public class HashMap01 {
    ...
    public static void main(String[] args) {
        ...
        //HashMap'ler entry'leri rastgele siralar, bu yuzden cok hizli caslisir.
        ...
        //replace("Angelina", 58, 61); methodu Map icinde "Angelina", 57 varsa 57'i 61'e donusturur, yoksa donusturmez.
        stdAges.replace("Angelina", 58, 61);
        System.out.println(stdAges); // {Tom=83, Angelina=61, Ajda=77, Brad=58, Ezel=39}

        //putIfAbsent("Ali", 60); methodu Map'te "Ali" key olarak yoksa Map'e "Ali=60"i ekler, varsa eklemez.
        ...
        //getOrDefault(); methodu Map'de olmayan "key"ler icin ikinci parametreye methodu koydugunuz degeri
        ...
        //containsValue("Alir"); methodu value'lari icerisinde Ali'nin olup olmadigini kontrol eder.
        ...
        //putAll(kidsAge); methodu stdAges Map'ine kidsAge Map'ini ekler. Dolayisiyla stAges Map'i degismis olur.
