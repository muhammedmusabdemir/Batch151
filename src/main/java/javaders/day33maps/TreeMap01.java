...
public class TreeMap01 {
    ...
    /*
       1)TreeMap "thread-safe" ve "synchronized" degildir.
         Note: Nap'lerde "multi thread" kullanmaniz gerektiginde sadece HashTable kullanabilirsiniz.
       2)TreeMap ler value'larda null kullanimina musaade eder, key'lerde etmez.
       2)TreeMap entry'leri key'lerine gore natural order'a gore siraya koyar. Bu yuzden coooook yavastir.
     */
