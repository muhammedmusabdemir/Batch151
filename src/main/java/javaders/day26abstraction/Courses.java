package javaders.day26abstraction;
    ...
    /*
      1)Bazen parent class'dakj methodun body'si hicbir class tarafindan kullanilmaz.
        Bu durumda parent'daki method'a body yazmak hic kullanilmadigi icin mantikli degildir.
        Biz de method'a body yazmayiz.
      ...
      3)Method'un body'sini yazmayinca Java hata verir, biz de "abstract"
        keyword'unu kullarak Java'ya bu method'un body'si olmayacak deriz.
      ...
      5)Parant'taki method abstract ise butun child class'lar o method'u override etmek zorundadir.
        Bu yuzden tum child'lar icin mecburi olmasini istedigimiz fonksiyonlari abstract yapmak mantikli bir secimdir.
      6)Body'si olan method'lar abstract class'larin icine yazilabilir.
     ...
     */
     ...
     /*
         ...
         "final" keyword i)Variable'larda  ii)meyhod'larda  iii)class'larda kullanilir.

         i)variable'larda kullanildiginda a)O variable'a kesinlikle deger atamasi yapilmalidir
                                          b)Ilk atanan deger degistirlemez
         ii)method'larda kullanildiginda a)O method'un body'si degistirilemez
                                         b)O method Override edilemez
         iii)class'larda kullanildiginda a)O class'in child class'i olamaz ama final classin kendisi child olabilir.
