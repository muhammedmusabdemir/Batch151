...
public class Animal {
    ...
    /*
       1) eat(){} method'u gibi bircok class'in kullanmasi gereken method'lari her class'a ayri ayri
          yazarsak;
       ...
       2) private class member'lar child class'lar tarafindan kullanilamaz.
          ...
          default class member'lar ayni package'de child class'ar tarafindan kullanilabilir.
          protected class member'lar farkli package'de da olsalar child class'ar tarafindan kullanilabilir.
