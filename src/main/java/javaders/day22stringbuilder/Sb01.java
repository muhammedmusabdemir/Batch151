...
public class Sb01 {
     ...
     /*
        ...
        2) String Class kullanarak String uretiriz Java nicin "StringBuilder" Class'i da olusturdu?
           "String" Class "immutable" (degistirilemez)  String uretir, "StringBuilder" Class "mutable" (degistirilebilir) String uretit.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(length); //5     "Money" ==> 5

        sb1.append("!").append(".................");

        int c = sb1.capacity();
        System.out.println(c); //21  iki katindan iki fazla artirma yapti //44    21x2 + 2 ==> 44
