package javaders.day24inheritancepolymorphism;
   ...
   /*
      ...
      3) super() her constructor'un ilk satirinda gorunmez olarak bulunur.
         Isterseniz gorunur sekilde de yaabilirsiniz.
      4) super() sizi parent classa'daki constructor'a tasir.
      5) this() sizi ayni class icindeki contructor'lar arasinda gezdirir.
      6) "this" icinde bulundugunuz class'daki variable'lari cagirmaya yarar,
         "super" parent class'daki variable'lari cagirnmaya yarar.
      7) Eger data type'lari arasinda "IS-A" ve "HAS-A" iliskisi varsa bu data type'lerine "COVARIANT" denir
    */

   /*
      1) Polimorphism ==> Coklu sekil
