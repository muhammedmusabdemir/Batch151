...
public class Sets01 {
    /*
      ...
      2)3 tane Set Class vardir;
        ...
        iii)TreeSet Class:
                 "TreeSet"ler elemanlari naturel order'a gore dizerler.
                 "TreeSet"ler elemanlari naturel order'a gore dizdiklerinden coooook yavastirlar.
                 En yavas Set "TreeSet"tir.
      3)TreeSet cok yavas olduigundan mumkun oldugu kadar TreeSet kullanmamaya calisiriz.
    ...
    public static void main(String[] args) {
        ...
        lhs.retainAll(ls);
        System.out.println(lhs); // [87, 124] ==> LinkedHashSet'teki fartkli elemanlar silindi
        System.out.println(ls); // [451, 87, 231, 124]
