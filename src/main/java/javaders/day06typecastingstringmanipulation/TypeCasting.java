...
public class TypeCasting {
    ...
    public static void main(String[] args) {
        ...
        //********************** Explicit Narrowing **************************\\
           ...
           Cunku cok ciddi Data kaybina hatta Datanin degismesine neden olabilir.
           Eger sayimiz donusturmeye calistigimiz variable'in sinirlari
           disinda ise; Java sayiyi mod islemine alir ve kalani yazdirir.
           Kalan bolenin yarisindan fazlaysa kanla sayiyi Java kucultmek ister ve
           bolumu 1 buyuterek kalani (-) isaretli olacak sekilde yazdirir.

            */

        // short data type'inde bir variable olusturup byte data type'ine ceviren kodu yaziniz
        short num = 260;
